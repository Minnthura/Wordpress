...
function alister_bank_get_project_category($cmsmasters_id, $taxonomy, $template_type = 'page', $show = true) {
	...
	if (get_the_terms($cmsmasters_id, $taxonomy)) {
		if ($template_type == 'page') {
			...
			if ($cmsmasters_option['alister-bank' . '_portfolio_project_cat']) {
				$out .= '<div class="project_details_item">' . 
					'<div class="project_details_item_title">' . esc_html__('Categories', 'alister-bank') . ':' . '</div>' . 
...
function alister_bank_get_project_likes($template_type = 'page', $show = true) {
	...
	if ($template_type == 'page') {
		...
		if ($cmsmasters_option['alister-bank' . '_portfolio_project_like']) {
			$out = '<div class="project_details_item">' . 
				'<div class="project_details_item_title">' . esc_html__('Likes', 'alister-bank') . ':' . '</div>' . 
...
function alister_bank_get_project_comments($template_type = 'page', $show = true) {
	...
	if (comments_open()) {
		if ($template_type == 'page') {
			...
			if ($cmsmasters_option['alister-bank' . '_portfolio_project_comment'] && comments_open()) {
				$out = '<div class="project_details_item">' . 
					'<div class="project_details_item_title">' . esc_html__('Comments', 'alister-bank') . ':' . '</div>' . 
...
function alister_bank_get_project_date($template_type = 'page', $show = true) {
	if ($template_type == 'page') {
		...
		if ($cmsmasters_option['alister-bank' . '_portfolio_project_date']) {
			$out .= '<div class="project_details_item">' . 
				'<div class="project_details_item_title">' . esc_html__('Date', 'alister-bank') . ':' . '</div>' . 
				'<div class="project_details_item_desc">' . 
...
function alister_bank_get_project_author($template_type = 'page', $show = true) {
	if ($template_type == 'page') {
		$out = '<span class="cmsmasters_project_author">' . 
			esc_html__('By', 'alister-bank') . ' ' . 
			'<a href="' . esc_url(get_author_posts_url(get_the_author_meta('ID'))) . '" title="' . esc_attr__('Projects by', 'alister-bank') . ' ' . esc_attr(get_the_author_meta('display_name')) . '" class="vcard author"><span class="fn" rel="author">' . esc_html(get_the_author_meta('display_name')) . '</span></a>' . 
		'</span>';
	} elseif ($template_type == 'post') {
		$cmsmasters_option = alister_bank_get_global_options();
		...
		if ($cmsmasters_option['alister-bank' . '_portfolio_project_author']) {
			$out .= '<div class="project_details_item">' . 
				'<div class="project_details_item_title">' . esc_html__('Author', 'alister-bank') . ':' . '</div>' . 
				'<div class="project_details_item_desc">' . 
					'<a href="' . esc_url(get_author_posts_url(get_the_author_meta('ID'))) . '" title="' . esc_attr__('Projects by', 'alister-bank') . ' ' . esc_attr(get_the_author_meta('display_name')) . '" class="vcard author"><span class="fn" rel="author">' . esc_html(get_the_author_meta('display_name')) . '</span></a>' . 
				'</div>' . 
			'</div>';
...
function alister_bank_get_project_tags($cmsmasters_id, $taxonomy, $show = true) {
	if (get_the_terms($cmsmasters_id, $taxonomy)) {
		...
		if ($cmsmasters_option['alister-bank' . '_portfolio_project_tag']) {
			$out = '<div class="project_details_item">' . 
				'<div class="project_details_item_title">' . esc_html__('Tags', 'alister-bank') . ':' . '</div>' . 
				'<div class="project_details_item_desc">' . 
...
function alister_bank_project_link($link_text, $link_url, $link_target, $show = true) {
	...
	if ( 
		$cmsmasters_option['alister-bank' . '_portfolio_project_link'] && 
		$link_text != '' && 
		$link_url != '' 
	) {
		$out = '<div class="project_details_item">' . 
			'<div class="project_details_item_title">' . esc_html__('Project Link', 'alister-bank') . ':' . '</div>' . 
			'<div class="project_details_item_desc">' . 
