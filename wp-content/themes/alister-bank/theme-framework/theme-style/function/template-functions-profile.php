...
function alister_bank_get_profile_category($cmsmasters_id, $taxonomy, $template_type = 'page', $show = true) {
	...
	if (get_the_terms($cmsmasters_id, $taxonomy)) {
		if ($template_type == 'page') {
			...
			if ($cmsmasters_option['alister-bank' . '_profile_post_cat']) {
				$out .= '<div class="profile_details_item">' . 
					'<div class="profile_details_item_title">' . esc_html__('Categories', 'alister-bank') . ':' . '</div>' . 
...
function alister_bank_get_profile_likes($template_type = 'page', $show = true) {
	...
	if ($template_type == 'page') {
		...
		if ($cmsmasters_option['alister-bank' . '_profile_post_like']) {
			$out = '<div class="profile_details_item">' . 
				'<div class="profile_details_item_title">' . esc_html__('Likes', 'alister-bank') . ':' . '</div>' . 
...
function alister_bank_get_profile_comments($template_type = 'page', $show = true) {
	...
	if (comments_open()) {
		if ($template_type == 'page') {
			...
			if ($cmsmasters_option['alister-bank' . '_profile_post_comment']) {
				$out .= '<div class="profile_details_item">' . 
					'<div class="profile_details_item_title">' . esc_html__('Comments', 'alister-bank') . ':' . '</div>' . 
...
function alister_bank_profile_open_style_social_icons() {
	...
	if ($social_icons != '') {
		...
		if ($social_icon_styles != '') {
			wp_add_inline_style('alister-bank-style', $social_icon_styles);
		}
	}
}
