...
function alister_bank_register_theme_js_scripts() {
	...
	wp_localize_script('alister-bank-theme-script', 'cmsmasters_theme_script', $cmsmasters_localize_array);
}
...
function alister_bank_theme_admin_scripts() {
	...
	wp_localize_script('cmsmasters-theme-settings-toggle', 'cmsmasters_theme_settings', array( 
		...
		'header_style' => $cmsmasters_option['alister-bank' . '_header_styles'] 
	));
}
...
register_nav_menus(array( 
    'primary' => 	esc_html__('Primary Navigation', 'alister-bank'), 
    'footer' => 	esc_html__('Footer Navigation', 'alister-bank'), 
	'top_line' => 	esc_html__('Top Line Navigation', 'alister-bank') 
));
...
function alister_bank_fallback_menu($args) {
	...
	echo '<div class="navigation_wrap">' . "\n" . 
		'<ul id="navigation" class="' . 
			'navigation ' . 
			($cmsmasters_option['alister-bank' . '_header_styles'] == 'default' ? 'mid_nav' : 'bot_nav') . 
		'">' . "\n";
	...
	$form = "<div class=\"search_bar_wrap\">
		<form method=\"get\" action=\"" . esc_url(home_url('/')) . "\">
			<p class=\"search_field\">
				<input name=\"s\" placeholder=\"" . esc_attr__('enter keywords', 'alister-bank') . "\" value=\"\" type=\"search\" />
			</p>
