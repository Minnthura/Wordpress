...
function alister_bank_get_custom_page_meta_fields() {
	...
	$cmsmasters_global_layout = (isset($cmsmasters_option['alister-bank' . '_layout']) && $cmsmasters_option['alister-bank' . '_layout'] !== '') ? $cmsmasters_option['alister-bank' . '_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_header_overlaps = (isset($cmsmasters_option['alister-bank' . '_header_overlaps']) && $cmsmasters_option['alister-bank' . '_header_overlaps'] !== '') ? (($cmsmasters_option['alister-bank' . '_header_overlaps'] == 1) ? 'true' : 'false') : 'false';
	...
	$custom_page_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Header Overlaps Content', 'alister-bank'), 
		...
		array( 
			'label'	=> esc_html__('Disabled Heading Block', 'alister-bank'), 
			'desc'	=> esc_html__('Use this checkbox to disable heading block', 'alister-bank'), 
