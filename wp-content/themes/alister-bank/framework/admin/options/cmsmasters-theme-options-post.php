...
function alister_bank_get_custom_post_meta_fields() {
	...
	$cmsmasters_global_blog_post_layout = (isset($cmsmasters_option['alister-bank' . '_blog_post_layout']) && $cmsmasters_option['alister-bank' . '_blog_post_layout'] !== '') ? $cmsmasters_option['alister-bank' . '_blog_post_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_blog_post_title = (isset($cmsmasters_option['alister-bank' . '_blog_post_title']) && $cmsmasters_option['alister-bank' . '_blog_post_title'] !== '') ? (($cmsmasters_option['alister-bank' . '_blog_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_share_box = (isset($cmsmasters_option['alister-bank' . '_blog_post_share_box']) && $cmsmasters_option['alister-bank' . '_blog_post_share_box'] !== '') ? (($cmsmasters_option['alister-bank' . '_blog_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_author_box = (isset($cmsmasters_option['alister-bank' . '_blog_post_author_box']) && $cmsmasters_option['alister-bank' . '_blog_post_author_box'] !== '') ? (($cmsmasters_option['alister-bank' . '_blog_post_author_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_more_posts_box = (isset($cmsmasters_option['alister-bank' . '_blog_more_posts_box'])) ? $cmsmasters_option['alister-bank' . '_blog_more_posts_box'] : 'related';
	...
	$tabs_array['cmsmasters_post'] = array( 
		'label' => esc_html__('Post', 'alister-bank'), 
	...
	$custom_post_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Don\'t Show Featured Image in Open Post', 'alister-bank'), 
		...
		array( 
			'label'	=> esc_html__('Post Image', 'alister-bank'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Gallery', 'alister-bank'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Audio Links', 'alister-bank'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Title', 'alister-bank'), 
		...
		array( 
			'label'	=> esc_html__("'Read More' Buttons Text", 'alister-bank'), 
			'desc'	=> esc_html__("Enter the 'Read More' button text that should be used in you blog shortcode", 'alister-bank'), 
			'id'	=> $cmsmasters_option_name . 'read_more', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('Read More', 'alister-bank') 
		), 
		array( 
			'id'	=> 'cmsmasters_post', 
			'type'	=> 'tab_finish' 
		...
		array( 
			'label'	=> esc_html__('Page Layout', 'alister-bank'), 
			'desc'	=> '', 
			'id'	=> 'cmsmasters_layout', 
			'type'	=> 'radio_img', 
			'hide'	=> '', 
			...
			'options' => array( 
				'r_sidebar' => array( 
					...
					'label' => esc_html__('Right Sidebar', 'alister-bank'), 
					'value'	=> 'r_sidebar' 
				), 
				'l_sidebar' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/sidebar_l.jpg', 
					'label' => esc_html__('Left Sidebar', 'alister-bank'), 
					'value'	=> 'l_sidebar' 
				), 
				'fullwidth' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/fullwidth.jpg', 
					'label' => esc_html__('Full Width', 'alister-bank'), 
					'value'	=> 'fullwidth' 
				) 
			) 
		), 
		array( 
			'label'	=> esc_html__('Choose Right\Left Sidebar', 'alister-bank'), 
			'desc'	=> '', 
