...
if (!function_exists('cmsmasters_google_fonts_list')) {
	function cmsmasters_google_fonts_list() {
		$fonts = alister_bank_get_google_fonts_list();
...
if (!function_exists('cmsmasters_text_transform_list')) {
	function cmsmasters_text_transform_list() {
		$list = array( 
			...
			'uppercase' => esc_html__('uppercase', 'alister-bank'), 
			'lowercase' => esc_html__('lowercase', 'alister-bank'), 
			'capitalize' => esc_html__('capitalize', 'alister-bank'), 
		);
