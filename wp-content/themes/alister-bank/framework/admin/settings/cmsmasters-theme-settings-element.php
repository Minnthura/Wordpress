...
function alister_bank_options_element_fields($set_tab = false) {
	...
	case 'code':
		...
		$options[] = array( 
			'section' => 'code_section', 
			'id' => 'alister-bank' . '_api_key', 
			'title' => esc_html__('Twitter API key', 'alister-bank'), 
			'desc' => '', 
			'type' => 'text', 
			'std' => $defaults[$tab]['alister-bank' . '_api_key'], 
			'class' => '' 
		);
		
		$options[] = array( 
			'section' => 'code_section', 
			'id' => 'alister-bank' . '_api_secret', 
			'title' => esc_html__('Twitter API secret', 'alister-bank'), 
			'desc' => '', 
			'type' => 'text', 
			'std' => $defaults[$tab]['alister-bank' . '_api_secret'], 
			'class' => '' 
		);
		
		$options[] = array( 
			'section' => 'code_section', 
			'id' => 'alister-bank' . '_access_token', 
			'title' => esc_html__('Twitter Access token', 'alister-bank'), 
			'desc' => '', 
			'type' => 'text', 
			'std' => $defaults[$tab]['alister-bank' . '_access_token'], 
			'class' => '' 
		);
		
		$options[] = array( 
			'section' => 'code_section', 
			'id' => 'alister-bank' . '_access_token_secret', 
			'title' => esc_html__('Twitter Access token secret', 'alister-bank'), 
			'desc' => '', 
			'type' => 'text', 
			'std' => $defaults[$tab]['alister-bank' . '_access_token_secret'], 
			'class' => '' 
		);
