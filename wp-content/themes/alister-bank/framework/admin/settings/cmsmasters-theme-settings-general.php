...
function alister_bank_options_general_fields($set_tab = false) {
	...
	case 'header':
		...
		$options[] = array( 
			...
			'choices' => array( 
				...
				esc_html__('Top Line Navigation', 'alister-bank') . '|nav' 
			) 
		);		
	...
	case 'content':
		...
		$options[] = array( 
			...
			'title' => esc_html__('Heading Custom Color Scheme by Default', 'alister-bank'), 
			'desc' => '', 
			'type' => 'select_scheme', 
		...
		$options[] = array( 
			...
			'title' => esc_html__('Bottom Custom Color Scheme', 'alister-bank'), 
			'desc' => '', 
			'type' => 'select_scheme', 
	...
	case 'footer':
		$options[] = array( 
			...
			'title' => esc_html__('Footer Custom Color Scheme', 'alister-bank'), 
			'desc' => '', 
			'type' => 'select_scheme', 
		...
		$options[] = array( 
			...
			'choices' => array( 
				esc_html__('None', 'alister-bank') . '|none', 
				esc_html__('Footer Navigation', 'alister-bank') . '|nav', 
