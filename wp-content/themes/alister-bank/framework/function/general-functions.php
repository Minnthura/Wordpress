...
function alister_bank_register_css_styles() {
	if (!is_admin()) {
		...
		wp_enqueue_style('alister-bank-theme-style', get_template_directory_uri() . '/style.css', array(), '1.0.0', 'screen, print');
		
		wp_enqueue_style('alister-bank-style', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/style.css', array(), '1.0.0', 'screen, print');
		
		wp_enqueue_style('alister-bank-adaptive', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/adaptive.css', array(), '1.0.0', 'screen, print');
		
		wp_enqueue_style('alister-bank-retina', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/retina.css', array(), '1.0.0', 'screen');
		
		
		if (is_rtl()) {
			wp_enqueue_style('alister-bank-rtl', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/css/rtl.css', array(), '1.0.0', 'screen');
		}
		...
		// iLightBox skins
		$ilightbox_skin = $cmsmasters_option['alister-bank' . '_ilightbox_skin'];
		...
		if (is_dir($style_dir) && get_option('cmsmasters_style_exists_' . 'alister-bank')) {
			$cmsmasters_styles_dir = $upload_dir['baseurl'] . '/cmsmasters_styles/';
		}
		
		
		wp_enqueue_style('alister-bank-fonts-schemes', $cmsmasters_styles_dir . 'alister-bank' . '.css', array(), '1.0.0', 'screen');
	}
}
...
function alister_bank_register_js_scripts() {
	...
	$cmsmasters_localize_array = array( 
		...
		'gmap_api_key' => 						$cmsmasters_option['alister-bank' . '_gmap_api_key'], 
		'gmap_api_key_notice' => 				esc_html__('Please add your Google Maps API key', 'alister-bank'), 
		'gmap_api_key_notice_link' => 			esc_html__('read more how', 'alister-bank'), 
		'primary_color' => 						$cmsmasters_option['alister-bank' . '_default_link'], 
		'ilightbox_skin' => 					$cmsmasters_option['alister-bank' . '_ilightbox_skin'], 
		'ilightbox_path' => 					$cmsmasters_option['alister-bank' . '_ilightbox_path'], 
		'ilightbox_infinite' => 				$cmsmasters_option['alister-bank' . '_ilightbox_infinite'], 
		'ilightbox_aspect_ratio' => 			$cmsmasters_option['alister-bank' . '_ilightbox_aspect_ratio'], 
		'ilightbox_mobile_optimizer' => 		$cmsmasters_option['alister-bank' . '_ilightbox_mobile_optimizer'], 
		'ilightbox_max_scale' => 				$cmsmasters_option['alister-bank' . '_ilightbox_max_scale'], 
		'ilightbox_min_scale' => 				$cmsmasters_option['alister-bank' . '_ilightbox_min_scale'], 
		'ilightbox_inner_toolbar' => 			$cmsmasters_option['alister-bank' . '_ilightbox_inner_toolbar'], 
		'ilightbox_smart_recognition' => 		$cmsmasters_option['alister-bank' . '_ilightbox_smart_recognition'], 
		'ilightbox_fullscreen_one_slide' => 	$cmsmasters_option['alister-bank' . '_ilightbox_fullscreen_one_slide'], 
		'ilightbox_fullscreen_viewport' => 		$cmsmasters_option['alister-bank' . '_ilightbox_fullscreen_viewport'], 
		'ilightbox_controls_toolbar' => 		$cmsmasters_option['alister-bank' . '_ilightbox_controls_toolbar'], 
		'ilightbox_controls_arrows' => 			$cmsmasters_option['alister-bank' . '_ilightbox_controls_arrows'], 
		'ilightbox_controls_fullscreen' => 		$cmsmasters_option['alister-bank' . '_ilightbox_controls_fullscreen'], 
		'ilightbox_controls_thumbnail' => 		$cmsmasters_option['alister-bank' . '_ilightbox_controls_thumbnail'], 
		'ilightbox_controls_keyboard' => 		$cmsmasters_option['alister-bank' . '_ilightbox_controls_keyboard'], 
		'ilightbox_controls_mousewheel' => 		$cmsmasters_option['alister-bank' . '_ilightbox_controls_mousewheel'], 
		'ilightbox_controls_swipe' => 			$cmsmasters_option['alister-bank' . '_ilightbox_controls_swipe'], 
		'ilightbox_controls_slideshow' => 		$cmsmasters_option['alister-bank' . '_ilightbox_controls_slideshow'], 
		'ilightbox_close_text' => 				esc_html__('Close', 'alister-bank'), 
		'ilightbox_enter_fullscreen_text' => 	esc_html__('Enter Fullscreen (Shift+Enter)', 'alister-bank'), 
		'ilightbox_exit_fullscreen_text' => 	esc_html__('Exit Fullscreen (Shift+Enter)', 'alister-bank'), 
		'ilightbox_slideshow_text' => 			esc_html__('Slideshow', 'alister-bank'), 
		'ilightbox_next_text' => 				esc_html__('Next', 'alister-bank'), 
		'ilightbox_previous_text' => 			esc_html__('Previous', 'alister-bank'), 
		'ilightbox_load_image_error' => 		esc_html__('An error occurred when trying to load photo.', 'alister-bank'), 
		'ilightbox_load_contents_error' => 		esc_html__('An error occurred when trying to load contents.', 'alister-bank'), 
		'ilightbox_missing_plugin_error' => 	esc_html__("The content your are attempting to view requires the <a href='{pluginspage}' target='_blank'>{type} plugin<\/a>.", 'alister-bank') 
	);
	...
	wp_enqueue_script('alister-bank-script', get_template_directory_uri() . '/js/jquery.script.js', array('jquery'), '1.0.0', true);
	
	wp_localize_script('alister-bank-script', 'cmsmasters_script', $cmsmasters_localize_array);
	
	wp_enqueue_script('alister-bank-theme-script', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/js/jquery.theme-script.js', array('jquery', 'alister-bank-script'), '1.0.0', true);
	...
	if ( 
		...
		isset($cmsmasters_option['alister-bank' . '_gmap_api_key']) && 
		$cmsmasters_option['alister-bank' . '_gmap_api_key'] != '' 
	) {
		wp_enqueue_script('gMapAPI', '//maps.googleapis.com/maps/api/js?key=' . $cmsmasters_option['alister-bank' . '_gmap_api_key'], array('jquery'), '1.0.0', true);
	...
	$cmsmasters_custom_js = stripslashes($cmsmasters_option['alister-bank' . '_custom_js']);
	
	wp_add_inline_script('alister-bank-script', $cmsmasters_custom_js);
...
if (!function_exists('alister_bank_theme_google_fonts_generate')) {

function alister_bank_theme_google_fonts_generate() {
	$cmsmasters_option = alister_bank_get_global_options();
	...
	foreach (cmsmasters_google_fonts_list() as $key => $value) {
		if ( 
			(isset($cmsmasters_option['alister-bank' . '_content_font_google_font']) && $key == $cmsmasters_option['alister-bank' . '_content_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['alister-bank' . '_link_font_google_font']) && $key == $cmsmasters_option['alister-bank' . '_link_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['alister-bank' . '_nav_title_font_google_font']) && $key == $cmsmasters_option['alister-bank' . '_nav_title_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['alister-bank' . '_nav_dropdown_font_google_font']) && $key == $cmsmasters_option['alister-bank' . '_nav_dropdown_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['alister-bank' . '_h1_font_google_font']) && $key == $cmsmasters_option['alister-bank' . '_h1_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['alister-bank' . '_h2_font_google_font']) && $key == $cmsmasters_option['alister-bank' . '_h2_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['alister-bank' . '_h3_font_google_font']) && $key == $cmsmasters_option['alister-bank' . '_h3_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['alister-bank' . '_h4_font_google_font']) && $key == $cmsmasters_option['alister-bank' . '_h4_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['alister-bank' . '_h5_font_google_font']) && $key == $cmsmasters_option['alister-bank' . '_h5_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['alister-bank' . '_h6_font_google_font']) && $key == $cmsmasters_option['alister-bank' . '_h6_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['alister-bank' . '_button_font_google_font']) && $key == $cmsmasters_option['alister-bank' . '_button_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['alister-bank' . '_small_font_google_font']) && $key == $cmsmasters_option['alister-bank' . '_small_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['alister-bank' . '_input_font_google_font']) && $key == $cmsmasters_option['alister-bank' . '_input_font_google_font'] && $key != '') || 
			(isset($cmsmasters_option['alister-bank' . '_quote_font_google_font']) && $key == $cmsmasters_option['alister-bank' . '_quote_font_google_font'] && $key != '') 
		) {
			$keys[] = $key;
		}
	}
...
add_action('wp_enqueue_scripts', 'alister_bank_theme_google_fonts_generate');
...
function alister_bank_the_widgets_init() {
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Sidebar', 'alister-bank'), 
            'id' => 'sidebar_default', 
            'description' => esc_html__('Widgets in this area will be shown in all left and right sidebars till you don\'t use custom sidebar.', 'alister-bank'), 
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Bottom Sidebar', 'alister-bank'), 
            'id' => 'sidebar_bottom', 
            'description' => esc_html__('Widgets in this area will be shown at the bottom of middle block below the content and middle sidebar, but above footer.', 'alister-bank'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Archive Sidebar', 'alister-bank'), 
            'id' => 'sidebar_archive', 
            'description' => esc_html__('Widgets in this area will be shown in all left and right sidebars on archives pages.', 'alister-bank'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
    ...
    register_sidebar(
        array(
            'name' => esc_html__('Search Sidebar', 'alister-bank'), 
            'id' => 'sidebar_search', 
            'description' => esc_html__('Widgets in this area will be shown in left or right sidebar on search page.', 'alister-bank'), 
            'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
            'after_widget' => '</aside>', 
            'before_title' => '<h3 class="widgettitle">', 
            'after_title' => '</h3>'
	...
	if (isset($cmsmasters_option['alister-bank' . '_sidebar']) && sizeof($cmsmasters_option['alister-bank' . '_sidebar']) > 0) {
		foreach ($cmsmasters_option['alister-bank' . '_sidebar'] as $sidebar) {
			register_sidebar(array( 
				'name' => $sidebar, 
				'id' => generateSlug($sidebar, 45), 
				'description' => esc_html__('Custom sidebar created with cmsmasters admin panel.', 'alister-bank'), 
				'before_widget' => '<aside id="%1$s" class="widget %2$s">', 
				'after_widget' => '</aside>', 
				'before_title' => '<h3 class="widgettitle">', 
				'after_title' => '</h3>' 
...
if (function_exists('add_theme_support')) {
	...
	function alister_bank_add_post_formats_to_project() {
		add_post_type_support('project', 'post-formats');
		
		register_taxonomy_for_object_type('post_format', 'project');
	}
	
	add_action('init', 'alister_bank_add_post_formats_to_project', 11);
...
function alister_bank_generate_front_css() {
	...
	wp_add_inline_style('alister-bank-retina', $shortcodes_css);
}
...
function alister_bank_add_global_icons() {
	...
	if ($wp_filesystem) {
		...
		update_option('cmsmasters_' . 'alister-bank' . '_icons', serialize($arr));
		
		update_option('cmsmasters_' . 'alister-bank' . '_icons_custom', serialize($arr_custom));
	}
}
...
function cmsmasters_composer_icons() {
	...
	if ( 
		...
		$icons = get_option('cmsmasters_' . 'alister-bank' . '_icons');
		
		$icons_custom = get_option('cmsmasters_' . 'alister-bank' . '_icons_custom');
		...
		} elseif (wp_script_is('alister-bank-lightbox-js', 'queue')) {
			wp_add_inline_script('alister-bank-lightbox-js', $out, 'before');
		}
	}
}
...
function alister_bank_write_styles($styles, $filename = '') {
	...
	if ($is_dir === false) {
		update_option('cmsmasters_style_dir_writable_' . 'alister-bank', 'false');
		
		update_option('cmsmasters_style_exists_' . 'alister-bank', 'false');
	...
	$file = trailingslashit($style_dir) . (($filename != '') ? $filename : 'alister-bank') . '.css';
	...
	if ($created === true) {
		update_option('cmsmasters_style_dir_writable_' . 'alister-bank', 'true');
		
		update_option('cmsmasters_style_exists_' . 'alister-bank', 'true');
	}
}
...
function cmsmasters_get_tweets($username, $count) {
	...
	$numTweets = $count;
	$cacheTime = 1;
	$backupName = 'cmsmasters_' . 'alister-bank' . '_tweets_list_backup';
	
	
	$connection = new TwitterOAuth( 
		(($cmsmasters_option['alister-bank' . '_api_key'] != '') ? $cmsmasters_option['alister-bank' . '_api_key'] : ''), 
		(($cmsmasters_option['alister-bank' . '_api_secret'] != '') ? $cmsmasters_option['alister-bank' . '_api_secret'] : ''), 
		(($cmsmasters_option['alister-bank' . '_access_token'] != '') ? $cmsmasters_option['alister-bank' . '_access_token'] : ''), 
		(($cmsmasters_option['alister-bank' . '_access_token_secret'] != '') ? $cmsmasters_option['alister-bank' . '_access_token_secret'] : '')
	);
...
function alister_bank_theme_bg_styles() {
	...
	if ($cmsmasters_option['alister-bank' . '_theme_layout'] == 'boxed') {
		...
		if ($cmsmasters_bg_default == 'false') {
			...
			$cmsmasters_bg_col = $cmsmasters_option['alister-bank' . '_bg_col'];
			$cmsmasters_bg_img_enable = $cmsmasters_option['alister-bank' . '_bg_img_enable'];
			$cmsmasters_bg_img_str = $cmsmasters_option['alister-bank' . '_bg_img'];
			$cmsmasters_bg_pos = $cmsmasters_option['alister-bank' . '_bg_pos'];
			$cmsmasters_bg_rep = $cmsmasters_option['alister-bank' . '_bg_rep'];
			$cmsmasters_bg_att = $cmsmasters_option['alister-bank' . '_bg_att'];
			$cmsmasters_bg_size = $cmsmasters_option['alister-bank' . '_bg_size'];
		}
	...
	wp_add_inline_style('alister-bank-style', $out);
}
...
function alister_bank_logo() {
	...
	if ($cmsmasters_option['alister-bank' . '_logo_type'] == 'text') {
		if ($cmsmasters_option['alister-bank' . '_logo_title'] != '') {
			$blog_title = $cmsmasters_option['alister-bank' . '_logo_title'];
		} else {
			$blog_title = (get_bloginfo('name')) ? get_bloginfo('name') : 'Alister Bank';
		}
		
		
		if ($cmsmasters_option['alister-bank' . '_logo_subtitle'] != '') {
			$blog_descr = $cmsmasters_option['alister-bank' . '_logo_subtitle'];
		} else {
			$blog_descr = (get_bloginfo('description')) ? get_bloginfo('description') : esc_html__('Default Logo Subtitle', 'alister-bank');
		}
		...
		echo '<a href="' . esc_url(home_url('/')) . '" title="' . esc_attr($blog_title) . '" class="logo">' . "\n\t" . 
			'<span class="logo_text_wrap">' . 
				...
				($cmsmasters_option['alister-bank' . '_logo_subtitle'] ? '<span class="title_text">' . esc_html($blog_descr) . '</span>' : '') . 
			'</span>' . 
		'</a>';
	} else {
		...
		if ($cmsmasters_option['alister-bank' . '_logo_url'] == '') {
			...
			$logo_img = explode('|', $cmsmasters_option['alister-bank' . '_logo_url']);
			...
			if ($cmsmasters_option['alister-bank' . '_logo_url_retina'] != '') {
				$logo_img_retina = explode('|', $cmsmasters_option['alister-bank' . '_logo_url_retina']);
...
function alister_bank_theme_logo_styles() {
	...
	if ($cmsmasters_option['alister-bank' . '_logo_type'] == 'text') {
		if ($cmsmasters_option['alister-bank' . '_logo_custom_color']) {
			$out .= "
				#header a.logo span.title {
					" . cmsmasters_color_css('color', $cmsmasters_option['alister-bank' . '_logo_title_color']) . "
				}
				
				#header a.logo span.title_text {
					" . cmsmasters_color_css('color', $cmsmasters_option['alister-bank' . '_logo_subtitle_color']) . "
				}
			";
		}
	} else {
		...
		$header_mid_height = (($cmsmasters_option['alister-bank' . '_header_mid_height'] !== '') ? $cmsmasters_option['alister-bank' . '_header_mid_height'] : $defaults[$tab]['alister-bank' . '_header_mid_height']);
...
function alister_bank_footer_logo($cmsmasters_option) {
	...
	if ($cmsmasters_option['alister-bank' . '_footer_logo_url'] == '') {
		...
		$footer_logo_img = explode('|', $cmsmasters_option['alister-bank' . '_footer_logo_url']);
		...
		if ($cmsmasters_option['alister-bank' . '_footer_logo_url_retina'] != '') {
			$footer_logo_img_retina = explode('|', $cmsmasters_option['alister-bank' . '_footer_logo_url_retina']);
...
<div class=\"social_wrap\">
	<div class=\"social_wrap_inner\">
		...
		foreach ($cmsmasters_option['alister-bank' . '_social_icons'] as $cmsmasters_social_icons) {
...
function alister_bank_get_comments($class = false, $show = false, $add_html = false) { 
	...
	if ($add_html) {
		$text = (get_comments_number() == '1') ? esc_html__('comment', 'alister-bank') : esc_html__('comments', 'alister-bank');
	} else {
		$text = '';
	}
	...
	if (comments_open()) {
		$out .= '<span class="cmsmasters_comments' . ($class ? ' ' . $class : '') . '">' . 
			'<a class="cmsmasters_theme_icon_comment" href="' . esc_url(get_comments_link()) . '" title="' . esc_attr__('Comment on', 'alister-bank') . ' ' . esc_attr(get_the_title()) . '">' . 
...
function alister_bank_theme_page_layout_scheme() {
	...
	} elseif (CMSMASTERS_TRIBE_EVENTS && tribe_is_event_query() && isset($cmsmasters_option['alister-bank' . '_events_layout'])) {
		$cmsmasters_layout = $cmsmasters_option['alister-bank' . '_events_layout'];
	} elseif (is_archive() || is_home()) {
		$cmsmasters_layout = $cmsmasters_option['alister-bank' . '_archives_layout'];
	} elseif (is_search()) {
		$cmsmasters_layout = $cmsmasters_option['alister-bank' . '_search_layout'];
	} else {
		$cmsmasters_layout = $cmsmasters_option['alister-bank' . '_other_layout'];
	}
	
	
	if ($cmsmasters_layout == '') {
		$cmsmasters_layout = $cmsmasters_option['alister-bank' . '_layout'];
	}
	...
	if( wp_verify_nonce($nonce, 'cmsmasters_ajax_like-nonce') ){
		...
		if ($post_ID != '') {
			...
			if (isset($_COOKIE['like-' . $post_ID]) || count($ipCheck) != 0) {
				...
				if ($add_html == 'true') {
					$text = ($plusLike == '1') ? esc_html__('like', 'alister-bank') : esc_html__('likes', 'alister-bank');
				} else {
					$text = '';
				}
...
function cmsmasters_ajax_apply_theme_style_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_apply_theme_style-nonce')) {
		if (isset($_POST['theme_style'])) {
			update_option('cmsmasters_alister-bank_theme_style', $_POST['theme_style']);
		}
...
function alister_bank_theme_style_change() {
	if (get_option('cmsmasters_options_alister-bank' . CMSMASTERS_THEME_STYLE . '_theme_style')) {
		return;
	} else {
...
function cmsmasters_ajax_export_settings_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_export_settings-nonce')) {
		...
		foreach (alister_bank_all_color_schemes_list() as $key => $value) {
			$cmsmasters_global_colors[] = 'cmsmasters_options_' . 'alister-bank' . CMSMASTERS_THEME_STYLE . '_color_' . $key;
		}
