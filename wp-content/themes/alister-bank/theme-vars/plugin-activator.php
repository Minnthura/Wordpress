...
function alister_bank_register_theme_plugins() { 
	$plugins = array( 
		array( 
			'name'					=> esc_html__('CMSMasters Contact Form Builder', 'alister-bank'), 
		...
		array( 
			'name'					=> esc_html__('Cookie Notice', 'alister-bank'), 
			'slug'					=> 'cookie-notice', 
			'required'				=> false 
		), 
		array( 
		...
		array( 
			'name' 					=> esc_html__('WordPress SEO by Yoast', 'alister-bank'), 
			'slug' 					=> 'wordpress-seo', 
			'required' 				=> false 
		), 
		array( 
