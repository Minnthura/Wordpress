...
function alister_bank_settings_general_defaults($id = false) {
	$settings = array( 
		...
		'content' => array( 
			'alister-bank' . '_layout' => 					'fullwidth', 
			'alister-bank' . '_archives_layout' => 			'fullwidth', 
			'alister-bank' . '_search_layout' => 			'fullwidth', 
			'alister-bank' . '_other_layout' => 				'fullwidth', 
...
/* Add Google Font */
if (!function_exists('alister_bank_add_google_font')) {

function alister_bank_add_google_font($fonts) {
	$fonts_new = array();
...
add_filter('alister_bank_google_fonts_list_filter', 'alister_bank_add_google_font');
...
function alister_bank_settings_element_defaults($id = false) {
	$settings = array( 
		...
		'code' => array( 
			...
			'alister-bank' . '_api_key' => 				'', 
			'alister-bank' . '_api_secret' => 			'', 
			'alister-bank' . '_access_token' => 			'', 
			'alister-bank' . '_access_token_secret' => 	'' 
		), 
		'recaptcha' => array( 
